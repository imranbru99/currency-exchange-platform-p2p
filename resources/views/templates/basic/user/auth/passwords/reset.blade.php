              ...
              <div class="col-lg-6">
                <div class="account-thumb bg_img h-100 d-flex flex-wrap align-items-center justify-content-center rounded-3" style="background-image: url('{{ getImage('assets/images/frontend/auth/' .@$bg->data_values->image, '1920x1280') }}');">
                  <div class="text-center">
                    <p class="text-dark mt-2"><a href="{{ route('user.login') }}" >@lang('Login Here')</a></p>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="account-content">
                  ...
                  <form method="POST" action="{{ route('user.password.update') }}">
                    ...
                    <div class="form-group">
                      <label class="mb-0" for="password-confirm">@lang('Confirm Password')</label>
                      <input id="password-confirm" type="password" class="form--control" name="password_confirmation" required>
                    </div>

                    <div class="text-center mt-4">
                      <button type="submit" class="btn btn--gradient w-100">@lang('Reset Password')</button>
                    </div>
                  </form>
                </div>
              </div>
