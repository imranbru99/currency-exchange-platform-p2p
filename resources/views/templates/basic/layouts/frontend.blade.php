...
<script>
  ...
  {{-- old start  --}}
    ...
    <link rel="stylesheet" href="{{ asset($activeTemplateTrue . 'gold/gold/css/bootstrap.min.css') }}">
    ...
    <link href="{{ asset($activeTemplateTrue . 'css/color.php') }}?color={{ $general->base_color }}"
        rel="stylesheet" />
    {{-- old end  --}}
  <meta charset="UTF-8">
