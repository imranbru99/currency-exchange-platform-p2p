<div class="sidebar {{ sidebarVariation()['selector'] }} {{ sidebarVariation()['sidebar'] }} {{ @sidebarVariation()['overlay'] }} {{ @sidebarVariation()['opacity'] }}"
            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.Status')}}">
                            <a href="{{route('admin.Status')}}" class="nav-link ">
                                ...
                                <span class="menu-title">@lang('Active User')</span>
                            </a>
               </li>
                <li class="sidebar-menu-item ">
                    <a href="clearme" class="nav-link">
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.currency')}}">
                    <a href="{{route('admin.currency')}}" class="nav-link"
                       data-default-url="{{ route('admin.currency') }}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.exchange.*',3)}}">
                        <i class="menu-icon las la-exchange-alt"></i>
                        <span class="menu-title">@lang('Manage Exchange')</span>
                        @if(0 < $pending_exchange)
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.exchange.*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive(['admin.exchange.all'])}}">
                                <a href="{{route('admin.exchange.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Exchange')</span>
                                    @if($pending_exchange)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pending_exchange}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive(['admin.exchange.total.approve'])}}">
                                <a href="{{route('admin.exchange.total.approve')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Exchange')</span>
                                    
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive(['admin.exchange.total.pending'])}}">
                                <a href="{{route('admin.exchange.total.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Exchange')</span>
                                    @if($pending_exchange)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pending_exchange}}</span>
                                    @endif
                                </a>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.exchange.total.refund'])}}">
                                <a href="{{route('admin.exchange.total.refund')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Refunded Exchange')</span>
                                    
                                </a>
                            </li>


                             <li class="sidebar-menu-item {{menuActive(['admin.exchange.total.cancel'])}}">
                                <a href="{{route('admin.exchange.total.cancel')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Cancel Exchange')</span>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.post*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.post.approved'])}}">
                                <a href="{{route('admin.post.approved')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Topics')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.post.all')}}">
                                <a href="{{route('admin.post.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Topics')</span>
                                </a>
                            </li>
                          <li class="sidebar-menu-item {{menuActive(['admin.post.comment'])}}">
                                <a href="{{route('admin.post.comment')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('comment Topics')</span>
                                    @if($pending_Comment)
                                    <span class="menu-badge pill bg--primary ml-auto">{{$pending_Comment}}</span>
                                @endif
                                </a>
                            </li>
 ...
 <li class="sidebar-menu-item sidebar-dropdown">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.forum')}}">
                    <a href="{{route('admin.forum')}}" class="nav-link ">
                        <i class="menu-icon las la-layer-group"></i>
                        <span class="menu-title">@lang('Forum')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.sub.category')}}">
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.refferal')}}">
                    <a href="{{route('admin.refferal')}}" class="nav-link"
                    data-default-url="{{ route('admin.refferal') }}">
              ...
              <li class="sidebar-menu-item  {{menuActive('admin.gateway.automatic.index')}}">
                ...
                data-default-url="{{ route('admin.gateway.automatic.index') }}">
                    <i class="menu-icon las la-credit-card"></i>
                    <span class="menu-title">@lang('Payment Gateways')</span>
                    
                </a>
            </li>
 <li class="sidebar-menu-item {{menuActive('admin.ad')}}">
                    <a href="{{route('admin.ad')}}" class="nav-link ">
