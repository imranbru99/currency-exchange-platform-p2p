                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                       ...
                                       <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div class="card border--dark mt-3">
                                            ...
                                            <h5 class="card-header bg--dark">@lang('Account Details (Only Account)')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label class="w-100 font-weight-bold">@lang('Only Account') <span class="text-danger">*</span></label>
                                                    <input class="form-control border-radius-5 nicEdit" name="account_details" value="{{ old('account_details') }}" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
