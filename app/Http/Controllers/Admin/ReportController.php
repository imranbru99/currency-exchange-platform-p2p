...
class ReportController extends Controller
{
    public function transaction()
    {
        ...
        return view('admin.reports.transactions', compact('pageTitle', 'transactions', 'empty_message'));
    }
    ...
    public function loginHistory(Request $request)
    {
        if ($request->search) {
            ...
            return view('admin.reports.logins', compact('pageTitle', 'empty_message', 'search', 'login_logs'));
        }
        $pageTitle = 'User Login History';
        $empty_message = 'No users login found.';
        $login_logs = UserLogin::orderBy('id','desc')->paginate(getPaginate());
        return view('admin.reports.logins', compact('pageTitle', 'empty_message', 'login_logs'));
    }
   ...
   public function delete($trx_id)
    {
        $trx = Transaction::where('id',$trx_id)->firstOrFail();
		$trx->delete();
